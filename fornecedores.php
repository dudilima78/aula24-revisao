    ...
    <table class="table table-success table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="frmfornecedor.php?idfornecedor=<?php echo $fornecedor->idfornecedor ?>" class="btn btn-warning">Editar</a></td>
                <td><a href="frmfornecedor.php?op=del&idfornecedor=<?php echo  $fornecedor->idfornecedor ?>" class="btn btn-danger">Excluir</a></td>
